...
perform row-wise normalisation so that: $z = \frac{x - \mu}\sigma$ to create `dat.n`
...
```{r, dendrogam, fig.cap="Clustering dendrograms",fig.pos="h!"}
...
```{r, heatmap-1, fig.cap="Heatmap of test data", fig.pos="H"}
...
```{r, interactive-heatmap,cache=FALSE,eval=FALSE}
